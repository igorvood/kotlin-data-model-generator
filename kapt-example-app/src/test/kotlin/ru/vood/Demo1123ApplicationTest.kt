...
internal class Demo1123ApplicationTest {
    ...
    @Test
    fun relationType() {
        Assertions.assertEquals(6, DataDictionaryForeignKeyEnum.values().size)
        DataDictionaryForeignKeyEnum.values().forEach {
            val relationType = when (it) {
                ...
                DataDictionaryForeignKeyEnum.DealParamOneToOne_Deal_FK -> RelationType.ONE_TO_ONE_OPTIONAL
